...
<nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        ...
        <a class="navbar-brand brand-logo-mini" href="index.jsp"><img src="./后台1_files/logo-mini.svg" alt="logo"></a>
      </div>
        ...
        <ul class="nav">
          ...
          <li class="nav-item active">
            <a class="nav-link" href="manage_user.jsp">
              <span class="menu-title" style="color:#fe7c96" >用户管理</span>
          ...
          <li class="nav-item sidebar-actions">
            <span class="nav-link">
              ...
              <a href="register.jsp"><button class="btn btn-gradient-danger btn-rounded btn-fw">+ 添加新用户</button></a>
      ...
      <div class="main-panel">
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="table-responsive">
					...
					<form method="post" action="u_deletes.jsp">
		...
		<% 	
			...
			while(i<intPageSize&&!rs.isAfterLast()){   
	          	int aid=rs.getInt("u_id");       
	          	String selectname=rs.getString("u_name");
		%>
          
		<tr>			
			<td><input type="checkbox" name="checkAll" id="checkAll" onclick="setSelectAll();"  value="<%=rs.getInt("u_id") %>" /></td>         
			<td><%=rs.getInt("u_id") %></td>
            <td><a href="u_list.jsp?selectname=<%=rs.getString("u_name") %>"><%=rs.getString("u_name") %></a></td>
           
			<td><%=rs.getString("u_email") %></td>
			<td><%=rs.getString("u_password") %></td>
			
			 <%-- <td><% String content=rs.getString("u_introduce");
			...
			<td align="center"><a href="u_edit.jsp?selectid=<%=aid%>">修改</a></td>
			<td align="center"><a onclick="firm()" href="u_delete.jsp?deleteid=<%=aid%>" >删除</a></td>
		...
		<td align="right"><input class="btn btn-inverse-danger btn-sm" type="submit" value="删除" onclick="firm()"></td>
		 ...
		 <tr height="50">
			<td colspan=5 align="right">
				...
				<% if (intPage < intPageCount) {  %>
				<a href="manage_user.jsp?page=<%=intPage + 1%>">下一页&#12288;</a>
				<% } if (intPage > 1) { %>
				<a href="manage_user.jsp?page=<%=intPage - 1%>">上一页</a>
				<% } }
				%>
			</td>
			
			</td  align="left">
			<td><a href="manage_user.jsp?page=<%=intPage = 1%>">首页&#12288;</a>
			<a href="manage_user.jsp?page=<%=intPageCount%>">尾页</a></td>
		 </tr>		
		</table>  
	</form>    
