...
<body>
				...
				<div class="row" style="padding: 1rem 10rem">
					<div class="col-12 grid-margin" style="margin-bottom: 1rem">
						<div class="card">
							...
							<FORM METHOD=POST ACTION="a_update_e.jsp" ENCTYPE="multipart/form-data">
	<% String sql = "SELECT * FROM articles where u_name='" + session.getAttribute("username") + "'";
		...
		if (rs.next()) {%>
		<div>
		<input type="text" class="form-control" id="exampleInputUsername1" NAME="tit" value="<%=rs.getString("a_title") %>" >
		...
		<div onmousedown="show_element(event)" style="clear: both"
			id="customized-buttonpane" class="editor" name="cont" > <%=rs.getString("a_content") %><%} %>
			</div>
